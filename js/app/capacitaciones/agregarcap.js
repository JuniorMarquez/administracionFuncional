...
app.controller('AgregarcapCtrl', ['$scope', '$state','$http', '$filter', '$modal', 'MyService', 'filterFilter', 'toaster','$timeout', 'FileUploader', function($scope,  $state ,$http, $filter,$modal, MyService, filterFilter, toaster,$timeout, FileUploader) {
...
var uploader = $scope.uploader = new FileUploader({
  ...
  $scope.toaster = {
    ...
    type3: 'info',
    text3: 'Capacitación agregada con éxito',
    title3: 'Información',
