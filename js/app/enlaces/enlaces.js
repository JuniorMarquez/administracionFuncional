...
$scope.enlaces = [];
 ...
 $scope.vigilante=MyService.data.contador;
   ...
   // dtInstance.rerender(); 
      ...
      $http.get('http://52.39.15.75:1346/enlace/').then(function (resp) {
...
$scope.openBorrar = function (iden,timeout) {
  ...
  var dato="";
  var datosCuenta="";
  $http.get('http://52.39.15.75:1346/enlace/'+iden).success(function(respuesta){        
...
//    $scope.popAprobacion();
//       $http.put('http://52.39.15.75:1346/miembro/'+MyService.data.idenMiembro, miembroAct)
//    $scope.getEnlaces2();
//    setTimeout(function() {
