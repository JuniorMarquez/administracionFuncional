...
app.controller('AgregarSlideCtrl', ['$scope', '$state','$http', '$filter', '$modal', 'MyService', 'filterFilter', 'toaster','$timeout', 'FileUploader', function($scope,  $state ,$http, $filter,$modal, MyService, filterFilter, toaster,$timeout, FileUploader) {


var uploader = $scope.uploader = new FileUploader({
        url: 'js/controllers/uploads/slides/upload.php'
