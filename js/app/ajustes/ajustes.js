...
//     $http.get('http://52.39.15.75:1346/usergesgan/'+MyService.data.idUsuario).then(function (resp) {
...
//   });
 ...
 //  $http.get('http://52.39.15.75:1346/ordeno/?idArticulo='+MyService.data.articuloConsultado.id).then(function (resp) {
